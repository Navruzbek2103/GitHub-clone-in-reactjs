    ...
    <div className="hero-menu-wrapper position-sticky">
      <ul className="hero-menu-list w-50  mx-auto align-items-center d-flex ">
        <li className="hero-menu-list-item">
          <NavLink
            to="/"
            className={`list-item-link rounded-2 d-flex align-items-center gap-1 text-dark fw-normal ${({
              isActive,
            }) => (isActive ? "fw-bold" : "")} `}
          >
        ...
        <li className="hero-menu-list-item">
          <NavLink
            to="/repositories"
            className={`list-item-link rounded-2 text-dark fw-normal d-flex align-items-center gap-1 `}
          >
            <RiGitRepositoryLine className="hero-menu-icon" size={`1.1em`} />
            Repositories
            <span className="menu-list-span rounded-4 fw-semibold">
              {user.public_repos}
            </span>
          </NavLink>
        </li>
        ...
        <li className="hero-menu-list-item">
          <NavLink
            to="/projects"
            className="list-item-link d-flex align-items-center gap-1 text-dark fw-normal rounded-2"
          >
